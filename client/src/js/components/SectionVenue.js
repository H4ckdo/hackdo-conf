    ...
    return (
      <div className="wrap-venue">
        <section className="section-venue">
          ...
          <article className="section-venue__article wrap-venue-map" id="venue-map-comfachoco"></article>
        </section>
        ...
        <section className="section-venue">
          <article className="section-venue__article">
            ...
            <p className="section-venue__article__copy">
              <b>ViveLab</b> de la institución educativa <b>Escuela Normal Superior de Quibdó</b>.
              <br/>
              <b>📍 a 9-124,, Cra. 6 #930, Quibdó, Chocó</b>
            </p>
          </article>
          <article className="section-venue__article wrap-venue-map" id="venue-map-normal"></article>
        </section>
