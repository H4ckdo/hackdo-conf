module.exports = {
  ...
  show: function (req, res) {
  	...
  	let response_cases = {
   	...
   	res.dispatchModel(Event.find({select : {id}}),response_cases,true);
  },//end show method
  ...
  update : function (req, res) {
  	...
  	let response_cases = {
		...
		res.dispatchModel(Event.update_by_id(id,update),response_cases);
  },//end update method
  ...
  delete : function (req, res) {
  	...
  	res.dispatchModel(Event.destroy({select : {id}}),response_cases);
  }//end delete method
}
